...
if (isset($_POST['repass'])) {
  ...
  if (count($errors) == 0) {
     ...
     $query="UPDATE adminstudent SET password='$password' WHERE email='$email'";
...
<body style="background-image: url('assets/img/bgn.jpg');background-size: cover;">
    <div style="float:left; margin-top: 10px;margin-left: 20px;"><a class="btn btn-primary" style="background-color: #6665b1; " href="homepage.php"><i class="fa fa-home" style=" color: white;"></i> &nbsp;<b>Home</b></a></div><br><br>
...
<?php  endif ?>
            ...
            <div class="form-group"><input class="form-control" type="password" name="repassword" placeholder="Confirm Password" id="repassword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required></div>
